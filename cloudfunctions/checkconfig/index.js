...
exports.main = async (event, context) => {
  ...
  let secret_res = await db.collection('secret').doc(openid).get()
  console.info(secret_res)
  if (secret_res.data && secret_res.data.vika) {
    vika = new Vika({ token: secret_res.data.vika.token });
