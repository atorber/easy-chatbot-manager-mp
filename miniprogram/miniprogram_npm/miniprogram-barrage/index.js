...
/** *** */ (function (modules) { // webpackBootstrap
    ...
    /** */ (function (module, exports, __webpack_require__) {
      ...
      function getRandom() {
        const max = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 10
    ...
    /* 1 */
    /** */ (function (module, exports, __webpack_require__) {
      const _barrageDom = __webpack_require__(2)

      const _barrageDom2 = _interopRequireDefault(_barrageDom)

      const _barrageCanvas = __webpack_require__(3)

      const _barrageCanvas2 = _interopRequireDefault(_barrageCanvas)
      ...
      Component({
        ...
        methods: {
          getBarrageInstance: function getBarrageInstance() {
            const opt = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {}
          ...
          onAnimationend: function onAnimationend(e) {
            ...
            const tunnelid = _e$currentTarget$data.tunnelid
            const bulletid = _e$currentTarget$data.bulletid
          ...
          onTapBullet: function onTapBullet(e) {
            const _e$currentTarget$data2 = e.currentTarget.dataset
            const tunnelid = _e$currentTarget$data2.tunnelid
            const bulletid = _e$currentTarget$data2.bulletid
    ...
    /** */ (function (module, exports, __webpack_require__) {
      ...
      const substring = _require.substring
      const getRandom = _require.getRandom
      const getFontSize = _require.getFontSize
      ...
      const Barrage = (function () {
        ...
        Barrage.prototype.send = function send() {
          ...
          var timer = setInterval(function () {
            const tunnel = _this5.getIdleTunnel()
            if (tunnel) {
              _this5.addData([opt])
              clearInterval(timer)
            }
        ...
        Barrage.prototype.updateBullets = function updateBullets() {
          ...
          query.selectAll('.bullet-item').boundingClientRect(function (res) {
            ...
            for (let i = 0; i < res.length; i++) {
              const _res$i$dataset = res[i].dataset
              const tunnelid = _res$i$dataset.tunnelid
              const bulletid = _res$i$dataset.bulletid
        ...
        Barrage.prototype.animationend = function animationend(opt) {
          ...
          const tunnelId = opt.tunnelId
          const bulletId = opt.bulletId
    ...
    /** */ (function (module, exports, __webpack_require__) {
      ...
      const Bullet = (function () {
        function Bullet(barrage) {
          const opt = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {}
        ...
        Bullet.prototype.move = function move() {
          ...
          if (this.image.tail && !this.imageTail) {
            const _Image = this.canvas.createImage()
          ...
          if (this.imageHead) {
            const _image$head = this.image.head
            const _image$head$width = _image$head.width
            const width = _image$head$width === undefined ? this.fontSize : _image$head$width
            const _image$head$height = _image$head.height
            const height = _image$head$height === undefined ? this.fontSize : _image$head$height
            const _image$head$gap = _image$head.gap
            const gap = _image$head$gap === undefined ? 4 : _image$head$gap
          ...
          if (this.imageTail) {
            const _image$tail = this.image.tail
            const _image$tail$width = _image$tail.width
            const _width = _image$tail$width === undefined ? this.fontSize : _image$tail$width
            const _image$tail$height = _image$tail.height
            const _height = _image$tail$height === undefined ? this.fontSize : _image$tail$height
            const _image$tail$gap = _image$tail.gap
            const _gap = _image$tail$gap === undefined ? 4 : _image$tail$gap

            const _x2 = this.x + this.textWidth + _gap
            const _y = this.y - 0.5 * _height
      ...
      const Barrage = (function () {
        ...
        Barrage.prototype.getEnableTunnel = function getEnableTunnel() {
          ...
          const index = (0, _utils.getRandom)(this.enableTunnels.length)
        ...
        Barrage.prototype.getIdleTunnel = function getIdleTunnel() {
          ...
          const index = (0, _utils.getRandom)(this.idleTunnels.length)
